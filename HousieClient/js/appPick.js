...
switchTheme.addEventListener( "click", function( e ) {
	e.preventDefault();
	var isThemeLight = themeStylesheet.getAttribute( "href" ) === "style/main.css" ? true : false;
	if( isThemeLight ) {
		this.firstElementChild.innerText = "Light";
		themeStylesheet.setAttribute( "href", "style/main.dark.css" );
	}
	else {
		this.firstElementChild.innerText = "Dark";
		themeStylesheet.setAttribute( "href", "style/main.css" );
	}
});